...
class PlayScene extends BaseScene {
    ...
    constructor(config) {
        ...
        this.difficulties = {
            'easy': {
                ...
                pipeHorizontalDistanceRange: [260, 300]
            },
            'normal': {
                pipeVerticalDistanceRange:[260, 300],
                pipeHorizontalDistanceRange: [230, 260]
            },
            'hard': {
                pipeVerticalDistanceRange:[230, 260],
                pipeHorizontalDistanceRange: [210, 230]
            }
        }
    }
    ...
    createScore() {
        ...
        this.add.text(16, 52, `Best Score: ${bestScore || 0}`, {fontSize: '18px', fill: 'black'})
    ...
    checkGameStatus() {
        const birdTouchesTop = this.bird.y <= 0;
        const birdTouchesBottom = this.bird.getBounds().bottom >= this.config.height;
        if (birdTouchesBottom || birdTouchesTop) {
            this.gameOver();
        }
    }

    placePipe(lPipe, uPipe) {
    ...
    getRightMostPipe() {
        return Math.max(...this.pipes.getChildren().map(a => a.x));
    }
